...
class QuestionsAgricultural {
  ...
  static List<QuestionsAgricultural> getDataQuestion() {
    return [
      ...
      QuestionsAgricultural(itemNumber: '1.1.4', title: 'Uso de buenas practicas ganaderas', itemSubtitle: '1.1.4.5', subtitle: '¿Cómo maneja el sistema de nutrución de su producción?', optionsQuestion: {'A':'No conoce ningun plan nutricional animal.', 'B':'Conoce el plan nutricional pero no aplica.', 'C':'Conoce el plan nutricional pero no siempre la aplica', 'D':'Implementa el plan nutricional animal.'}),
      ...
      QuestionsAgricultural(itemNumber: '1.1.8', title: 'Registros', itemSubtitle: '1.1.8.2', subtitle: '¿Qué nivel de conocimientos administrativos posee sobre su sistema de producción?', optionsQuestion: {'A':'Alto.', 'B':'Intermedio.', 'C':'Básico.','D':'Ninguno.'}),
